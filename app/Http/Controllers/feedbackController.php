...
class feedbackController extends Controller
{
    ...
    {
        $reviews=Review::with("feedbacks")->get();
        return view('tiu.feedback', ['reviews' => $reviews]);
    }
    ...
    public function show($userId)
    {
        ...
        $files=File::where("u_id",$userId)->get();
        return view('tiu.attachs', ['cards' => $cards,'files'=>$files]);
    }
